...
export default function Header(){
  ...
  useEffect(() => {
    ...
    return (
      ...
      <Link href="/"><img src="images/logo.png" width="150" style={{display:"inline-block"}} alt="logo" /></Link>
      ...
      <Link href="/"><img src="images/logo.png" width="130" className='float-right mt-[-0.2cm]' style={{display:"inline-block"}}/></Link>
      </div>) : 
