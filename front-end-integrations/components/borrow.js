 ...
 useEffect(()=>{
  ...
  getTheData();  
    ...
    return (
        ...
        <div className="text-[#ccc] text-[90%]">Borrow on Creditas (P2P)</div>
        
        <div className="my-[1cm] bg-[#000] p-[0.5cm] rounded-xl lg:mx-[10%] md:mx-[10%]" style={{boxShadow:"2px 2px 2px 2px #00f"}}>
          <div className="mb-[0.5cm] text-center">To borrow tRBTC, create a loan. Another Creditas user will fund your loan. (P2P)</div>
